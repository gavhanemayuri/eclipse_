...
<body>
<div class="main">
  <ul style="position: absolute; left: 0; top: 0;padding: 30px">
    <li> <a style="text-decoration: none; padding: 15px;display: inline-block;background-color: #ea4c89; color: #ffffff;margin-bottom: 15px;" href="https://dribbble.com/Aravind_arWIN" class="button facebook" target="_blank">
        <i class="fa fa-facebook"></i> Dribbble
      </a></li>
           <li> <a style="text-decoration: none; padding: 15px;display: inline-block;background-color: #3b5998; color: #ffffff;margin-bottom: 15px;" href="https://www.facebook.com/aravind.gva" class="button facebook" target="_blank">
        <i class="fa fa-facebook"></i> Facebook
      </a></li>
           <li><a style="text-decoration: none; padding: 15px;display: inline-block;background: #d6249f; background: radial-gradient(circle at 150% 150%, #fdf497 0%, #fdf497 5%, #fd5949 45%,#d6249f 60%,#285AEB 90%); color: #ffffff;margin-bottom: 15px;" href="https://www.instagram.com/arvin_swaaag/?hl=en" class="button github" target="_blank">
        <i class="fa fa-github"></i> Instagram
      </a></li>
           <li><a style="text-decoration: none; padding: 15px;display: inline-block;background-color: #008abe; color: #ffffff;margin-bottom: 15px;" href="https://twitter.com/Aravind_arWIN" class="button twitter" target="_blank">
