...
Connection con = DriverManager.getConnection( "jdbc:postgresql://localhost:5433/task1","postgres","Mayuri123");

PreparedStatement ps=con.prepareStatement("select * from login where email='"+x+"' and password= '"+y+"' ");
